...
public class PassiveProviderLocationInspection extends LocalInspectionTool {
    ...
    public PsiElementVisitor buildVisitor(@NotNull ProblemsHolder holder, boolean isOnTheFly) {
        return new JavaElementVisitor() {
            ...
            @NonNls
            private final String DESCRIPTION_TEMPLATE_PASSIVE_PROVIDER = "EcoAndroid: Cache [Switching to PASSIVE_PROVIDER] can be applied";
            private final String DESCRIPTION_TEMPLATE_PASSIVE_PROVIDER_INFO_WARNING = "EcoAndroid: Cache [Possible switch to PASSIVE_PROVIDER] can be applied";
